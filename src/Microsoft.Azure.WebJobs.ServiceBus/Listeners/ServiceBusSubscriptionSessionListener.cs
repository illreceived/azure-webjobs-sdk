...
{
    internal sealed class ServiceBusSubscriptionSessionListener : IListener
    {
        ...
        public ServiceBusSubscriptionSessionListener(MessagingFactory messagingFactory, string topicName, string subscription, ServiceBusSessionTriggerExecutor triggerExecutor, ServiceBusConfiguration config)
        {
            ...
            _messageProcessor = config.MessagingProvider.CreateMessageProcessor(SubscriptionClient.FormatSubscriptionPath(topicName, subscription));
        }
        ...
        private Task StartAsyncCore(CancellationToken cancellationToken)
        {
            ...
            _messagingProvider.RegisterSessionHandlerFactoryForTopic(_messagingFactory, _topicName, _subscription, sessionHandlerFactory);
